...
from _utils import _Data, Broker
...
#   Strategy Callable
##
StrategyCallable: TypeAlias = Callable[[np.ndarray, Broker], Decision]
...
def simple_bollinger_bands(data: np.ndarray, broker: Broker, sma1_window_size=14, bband_window_size=21) -> Decision:
